...
public class Utils {
     ...
     */
    public static ArrayList<File> createFileList(String source, String exclude){
        ...
        if (source == null || source.equals("")) {
            Utils.listFilesRecursively(source, filesToScan, excludeFiles);
        } else {
            String [] sources = source.split("\\|", 0);
            for (String s : sources) {
                Utils.listFilesRecursively(s, filesToScan, excludeFiles);
            }
